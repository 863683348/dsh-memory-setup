...
const want = ["memory_setup", "memory_status", "memory_update", "memory_project", "memory_lesson", "memory_review", "memory_export", "knowledge_add", "knowledge_search", "knowledge_list", "knowledge_remove"];
